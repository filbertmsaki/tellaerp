                    ...
                    <div class="card-body">
                        ...
                        <div class="fw-semibold fs-6 text-gray-500 mb-7">
                            ...
                            <div class="text-center mb-10">
                                <div class="text-gray-500 fw-semibold fs-6">Before continuing, could you verify your
                                    email address by clicking on the link we just emailed to you? If you didn't
                                    receive the email, we will gladly send you another.
                                </div>
                            </div>
                            <div class="d-flex flex-wrap flex items-center justify-between pb-lg-0">

                                <div>
                                    <form class="form w-100" novalidate="novalidate" id="kt_password_confirm_form"
                                        method="POST" action="{{ route('verification.send') }}">
                                        @csrf
                                        <button type="submit" id="kt_password_confirm_submit"
